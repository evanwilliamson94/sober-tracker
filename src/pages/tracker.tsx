...
const Tracker = () => {
  ...
  const handleMoodUpdate = (mood: string) => {
    ...
    if (chartInstance) {
      ...
      chartInstance.data.datasets[0].data.push(mood === 'Good' ? 3 : mood === 'Okay' ? 2 : 1); 
      ...
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="max-w-3xl w-full p-6 shadow-lg rounded-lg bg-white">
          ...
          <div className="flex justify-center mb-6">
            <label htmlFor="goal" className="text-lg font-medium text-gray-700 mr-3">Set Your Goal: </label>
            <select
              id="goal"
              value={selectedGoal}
          ...
          <h2 className="text-2xl font-bold text-gray-900">You&apos;ve been sober for:</h2>
            <p className="text-5xl font-extrabold text-indigo-600 mt-3">{daysSober} days</p>
          ...
          <div className="text-center text-xl text-indigo-600 italic mb-8">
            &quot;{quote}&quot;
          </div>

          {/* Mood Tracker */}
          <div className="text-center mb-10">
            <h2 className="text-2xl font-semibold">Track Your Mood</h2>
