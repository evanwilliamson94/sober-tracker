        ...
        {isLoading ? (
          ...
          <div className="mb-12">
            ...
            <div className="bg-gray-800 p-6 rounded-lg shadow-lg max-w-lg mx-auto">
              <img src={featuredPhoto.url} alt="Featured" className="w-full h-auto mb-4 rounded-lg" />
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            {photos.map(photo => (
              <div key={photo.id} className="bg-gray-800 p-6 rounded-lg shadow-lg">
                <img src={photo.url} alt={`Photo ${photo.id}`} className="w-full h-auto mb-4 rounded-lg" />
