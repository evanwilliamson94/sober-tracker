    ...
    <>
      ...
      <div className="max-w-7xl mx-auto p-6 bg-gray-900 text-white">
        ...
        <section className="mb-12">
          ...
          <img src="/images/budget-planning.jpg" alt="Organizing Budget" className="rounded-lg mb-4" />
        ...
        <section className="mb-12">
          ...
          <img src="/images/emotion-control.jpg" alt="Control of Emotions" className="rounded-lg mb-4" />
          <p className="text-lg mb-4">
            Emotional regulation is often one of the biggest challenges in recovery. Those recovering from addiction need to learn how to control emotional responses and deal with stress, frustration, and sadness healthily, without turning to substances.
          </p>
          <p className="text-lg">
        ...
        <section className="mb-12">
          ...
          <img src="/images/healthy-coping.jpg" alt="Healthy Coping Mechanisms" className="rounded-lg mb-4" />
          <p className="text-lg mb-4">
        ...
        <section className="mb-12">
          ...
          <img src="/images/social-skills.jpg" alt="Building Social Skills" className="rounded-lg mb-4" />
          <p className="text-lg mb-4">
        ...
        <section className="mb-12">
          ...
          <img src="/images/effective-communication.jpg" alt="Effective Communication" className="rounded-lg mb-4" />
          <p className="text-lg mb-4">
