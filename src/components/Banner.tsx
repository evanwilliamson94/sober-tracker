    ...
    <div className="fixed bottom-0 w-full bg-gradient-to-r from-indigo-600 to-blue-500 text-white py-4 px-4 text-center shadow-lg z-50">
      <div className="max-w-screen-xl mx-auto flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="flex space-x-4">
          <button
            className="flex items-center bg-white text-indigo-600 hover:bg-gray-100 py-2 px-4 md:px-6 rounded-lg font-bold transition duration-300 transform hover:scale-105"
